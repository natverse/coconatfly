...
So we can see the hemibrain TuTuB neurons have been typed into two subtypes, but the flywire neurons have not. First of all does cosine clustering in the hem
...
The following code could help find the ontology (FBBt) ids for these neurons:
