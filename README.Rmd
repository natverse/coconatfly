...
The first four datasets are either public (hemibrain, manc) or access can be
requested subject to agreeing to certain terms of use (flywire, fanc). 
The Male CNS dataset is currently in the early stages of 
