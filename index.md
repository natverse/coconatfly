...
![](reference/figures/coconatfly-200.jpg)
...
[`cf_ids()`](https://natverse.org/coconatfly/reference/cf_ids.md) which
allows you to specify a set of neurons from one or more datasets and
[`cf_meta()`](https://natverse.org/coconatfly/reference/cf_meta.md)
which fetches information about each neuron including its cell type. For
example let’s fetch information about DA1 projection neurons:
...
![](reference/figures/README-flywire-left-vs-right-1.png)
...
![](reference/figures/README-flywire-vs-hemibrain-1.png)
...
![](reference/figures/README-lal-cosine-cluster-1.png)
